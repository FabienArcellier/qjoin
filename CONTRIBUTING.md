...
## We discuss on discord

We use discord to discuss about the project. You can join the discussion on the [discord server](https://discord.gg/nMn9YPRGSY).
...
## Report bugs using Github's [issues](https://github.com/FabienArcellier/qjoin/issues)
...
Before commit or send a pull request, you have to execute `mypy` to check the syntax
